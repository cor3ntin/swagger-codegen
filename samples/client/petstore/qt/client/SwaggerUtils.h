...
//enum serialization
#define SWAGGER_SERIALIZE_QENUM(o,e,v)  swagger::serialize<QString>(o::staticMetaObject.enumerator\
    (o::staticMetaObject.indexOfEnumerator(#e)).valueToKey((static_cast<int>(v))))

#define SWAGGER_UNSERIALIZE_QENUM(o,e, k) [](const QJsonValue & json) -> boost::optional<o::e> {\
    auto key = swagger::unserialize<QString>(json);\
    if(!key) return {};\
    int v = o::staticMetaObject.enumerator\
    (o::staticMetaObject.indexOfEnumerator(#e)).keyToValue(qPrintable(*key));\
    if (v == -1) return {};\
    return boost::optional<o::e>{static_cast<o::e>(v)};\
    }(k)
